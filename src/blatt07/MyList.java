...
public class MyList<E> implements Cloneable, Iterable<E>, Visitable<E> {
   ...
   public boolean equals(Object obj) {
    ...
    private class Iterator<E> implements java.util.Iterator<E> {
        ...
        */
       public E next() {
          if(anfangszustand!=zustand) throw new ConcurrentModificationException("die Orignalliste wurde bearbeitet");
        ...
        */
       public void remove() {
          if(anfangszustand!=zustand) throw new ConcurrentModificationException("die Originalliste wurde bearbeitet");
