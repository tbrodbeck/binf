...
public class UncertainException {
   ...
   //kompiliert, Ausgabe: i = 2 Exception (java.lang.NumberFormatException)
   ...
   //i = 1 Exception (java.lang.RuntimeException)
   public int uncertain2() {
      ...
      //return i++; -> unreachable, sonst komplierts nicht
   }
   ...
   //i = 0 Exception (java.lang.RuntimeException)
   ...
   //i = 2 Exception (java.lang.RuntimeException)
   ...
   //man braucht throws sonst kompilierts nicht
   //i = 0 Exception (java.io.IOException)
